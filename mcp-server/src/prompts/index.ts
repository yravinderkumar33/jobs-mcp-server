...
export function registerPrompts(server: McpServer) {
  ...
  server.prompt(
    ...
    "System prompt for helping blue-collar job seekers in India",
    () => {
...
Help the user feel confident and well-prepared for their interview!`;
  ...
  server.prompt(
    "career-development",
    {
      currentRole: z.string().optional().describe("User's current job or role"),
      desiredRole: z.string().optional().describe("User's career aspiration")
    },
