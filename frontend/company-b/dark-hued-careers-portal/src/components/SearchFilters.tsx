...
export const SearchFilters = ({ onSearch }: SearchFiltersProps) => {
  ...
  useEffect(() => {
    ...
    if (urlCategory) {
      ...
      setShowFilters(true); // Show filters if category is set
    }
  }, [searchParams]);
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          <div className="flex-1 relative group">
            ...
            <Input
              ...
              className="pl-12 h-12 text-base search-focus"
            />
          </div>
          <div className="flex gap-2">
            ...
            <Button 
              ...
              className="h-12 px-8 text-base gradient-primary"
        ...
        {showFilters && (
          <div className="border-t border-border pt-6">
            <div className="flex justify-between items-center mb-4">
              <h4 className="text-lg font-semibold text-foreground">Filter Jobs</h4>
              <Button
                variant="ghost"
                size="sm"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-muted-foreground">Min Salary (₹)</label>
                <Input
                  type="number"
                  placeholder="15,000"
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-muted-foreground">Max Salary (₹)</label>
                <Input
                  type="number"
                  placeholder="50,000"
